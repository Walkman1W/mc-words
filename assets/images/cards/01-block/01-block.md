...
来源：`docs/Minecraft英语学习单词卡分类表 (1).docx` 里的 `方块类 Block` 分类。
...
| --- | --- | --- |
| Block | 方块 | This is a block. |
| Stone | 石头 | I see a stone block. |
| Grass Block | 草方块 | The grass block is green. |
| Dirt | 泥土 | I can dig dirt. |
| Cobblestone | 圆石 | Cobblestone is strong. |
| Sand | 沙子 | Sand is yellow. |
| Gravel | 沙砾 | Gravel can fall. |
| Clay | 黏土 | Clay is soft. |
| Snow Block | 雪块 | The snow block is white. |
| Ice | 冰 | Ice is very cold. |
| Glass | 玻璃 | Glass is clear. |
| Wood Planks | 木板 | I build with wood planks. |
| Oak Log | 橡木原木 | The oak log is brown. |
| Brick Block | 砖块 | The brick block is red. |
| Bookshelf | 书架 | The bookshelf has books. |
| Obsidian | 黑曜石 | Obsidian is very hard. |
| Wool | 羊毛 | Wool is soft. |
| Chest | 箱子 | I put items in the chest. |
| Crafting Table | 工作台 | I use a crafting table. |
| Furnace | 熔炉 | The furnace cooks food. |
| Door | 门 | Open the door, please. |
| Ladder | 梯子 | I climb the ladder. |
| Fence | 栅栏 | The fence keeps animals in. |
| Torch | 火把 | The torch gives light. |
| Bed | 床 | I sleep in a bed. |
